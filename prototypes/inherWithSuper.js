...
class Motorcycle extends Vehicle{
    constructor(){ // you can pass mk,md,y as well or leave empty 
        super(...arguments); //// you can pass mk,md,y as well or leave as ... arguments
        this.nW = 2;
    }
}